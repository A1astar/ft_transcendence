...
export class HomeViewBinder implements ViewEventBinder {
  bind() {
    ...
    document
      ...
      ?.addEventListener("click", this.onRegisterClick);
    document
      .getElementById("guest")
      ?.addEventListener("click", this.onGuestClick);
  }
  unbind() {
    document
      .getElementById("login")
    ...
    document
      .getElementById("register")
      ?.removeEventListener("click", this.onRegisterClick);
    document
      .getElementById("guest")
      ?.removeEventListener("click", this.onGuestClick);
  }
