...
export async function renderProfile() {
  if (appDiv) {
    ...
    try {
      ...
      accountBoxDiv.className +=
        " flex-1 px-3 py-1 min-w-[320px] max-w-[480px]";
      ...
      usernameBox.className =
        "bg-gray-800/30 rounded-lg p-2 mb-2 flex flex-col items-center";
      ...
      const twoFaLabel = createParagraphText(
