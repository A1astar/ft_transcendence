...
export function leftPaddleCollision(
  ball: Game["ball"],
...
export function rightPaddleCollision(
  ball: Game["ball"],
...
export function upPaddleCollision(
  ball: Game["ball"],
  paddle: Game["paddles"]["up"]
) {
...
export function downPaddleCollision(
  ball: Game["ball"],
  paddle: Game["paddles"]["down"]
) {
  const paddleLeft = paddle.x - paddle.width / 2;
  const paddleRight = paddle.x + paddle.width / 2;
  const paddleTop = paddle.y - paddle.height / 2;
